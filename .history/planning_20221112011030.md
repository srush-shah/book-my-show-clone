...
<b>Layout First Approach:</b> We create a default layout with certain components fixed. These components remain fixed and hencce are rendered only once and not everytime 
